...
//                    lanzarError("Error tiene que llenar todos los campos");
//
//                else if (controlador.cargarLocalidad((String) localidades.getSelectedValue(), (String) provincias.getSelectedValue()))
//                {
//                    Coordinate cordenada = Sistema.obtenerCoordenadasLocalidad((String) localidades.getSelectedValue(), (String) provincias.getSelectedValue());
//                    (mapa).agregarMarcador(cordenada.getLat(), cordenada.getLon(), (String) localidades.getSelectedValue());
//                }
//            }
//        });
//
...
public class VentanaPrincipal extends JFrame
{
	...
	public VentanaPrincipal()
	{
		...
		// --- boton de Aadir Localidad Personalizada ---
		JButton botonAnadirLocalidadPerzonalizada = new JButton("Aadir Localidad");
		...
		// --- boton de Aadir Localidad Predeterminada---
		JButton botonAnadirLocalidadPredeterminada = new JButton("Aadir Localidad");
